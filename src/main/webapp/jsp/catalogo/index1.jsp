...
if(listado_Productos!=null) {
	...
	for(int i=0; i<listado_Productos.size(); i++) {
		out.println(listado_Productos.get(i).getNombre());
		out.println(listado_Productos.get(i).getDescripcion());
		out.println(listado_Productos.get(i).getPrecio());
		out.println(listado_Productos.get(i).getStock());
	}
}
%>
